...
const UploadDropzone = ({ 
  ...
  return (
    <>
      <Card className="border-2 border-dashed border-slate-300 hover:border-slate-400 rounded-lg w-full max-w-2xl mx-auto h-[360px]">
  <CardContent className="p-0 h-full">
    <div
      {...getRootProps()}
      className={`w-full h-full flex flex-col items-center justify-center text-center cursor-pointer transition-colors ${
    ...
    >
      ...
      <Button
        variant="outline"
        className="mb-2 border-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800"
        onClick={(e) => {
          e.stopPropagation();
